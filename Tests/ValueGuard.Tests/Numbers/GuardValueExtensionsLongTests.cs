...
public sealed class GuardValueExtensionsLongTests
{
    ...
    public void Between_ValidRange_NoException(long value, long min, long max, bool excludeMin, bool excludeMax)
    ...
    public void Between_InvalidRange_ThrowException(long value, long min, long max, bool excludeMin, bool excludeMax)
        => Assert.Throws<GuardException>(()
            => Guard.Value(value).Between(min, max, excludeMin, excludeMax));
}