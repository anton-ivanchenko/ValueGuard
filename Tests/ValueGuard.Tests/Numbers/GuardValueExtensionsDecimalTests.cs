...
public sealed class GuardValueExtensionsDecimalTests
{
    ...
    public void Between_ValidRange_NoException(decimal value, decimal min, decimal max, bool excludeMin, bool excludeMax)
    ...
    public void Between_InvalidRange_ThrowException(decimal value, decimal min, decimal max, bool excludeMin, bool excludeMax)
        => Assert.Throws<GuardException>(()
            => Guard.Value(value).Between(min, max, excludeMin, excludeMax));
}