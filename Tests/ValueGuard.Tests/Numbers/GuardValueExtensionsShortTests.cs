...
public sealed class GuardValueExtensionsShortTests
{
    ...
    public void Between_ValidRange_NoException(short value, short min, short max, bool excludeMin, bool excludeMax)
    ...
    public void Between_InvalidRange_ThrowException(short value, short min, short max, bool excludeMin, bool excludeMax)
        => Assert.Throws<GuardException>(()
            => Guard.Value(value).Between(min, max, excludeMin, excludeMax));
}